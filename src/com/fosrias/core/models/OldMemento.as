 ...
 */
public class OldMemento extends AClass// implements IMemento
{
    //--------------------------------------------------------------------------
    //
    //  Constructor
     ...
     * Constructor
     */
    public function OldMemento(object:Object)
    {
        super(this);
    ...
    protected function checkSameObject(object:Object):void
    {
        ...
        if (name !=  _objectName)
        {
            throw new IllegalOperationError( className + " Error: Attempting " 
                ...
                + "memento. The memento is incompatible with a "
				+ getQualifiedClassName(this) + " class.");
        }  
    }   
}
